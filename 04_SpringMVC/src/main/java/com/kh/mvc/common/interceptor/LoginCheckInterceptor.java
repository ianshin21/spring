 ...
 * 	- 인터셉터를 구현하기 위해서는 HandlerInterceptor 인터페이스를 구현하거나  HandlerInterceptorAdapter 클래스를 상속하는 방법으로 구현해야 한다.
 * 
 * 필터와의 차이점 
...
public class LoginCheckInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// 반환값이 false인 경우 컨트롤러는 실행되지 않는다. 요청이 넘어가지 않는다
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		// /컨트롤로가 실행된 후에 필요한 작업을 할 수 있는 메소드
	...
	public void afterConcurrentHandlingStarted(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		// 비동기 요청시 postHandle, afterCompletion이 수행되지 않고 afterConcurrentHandlingStarted 메소드가 실행된다.  
